...

{
	...
	{
		internal static bool TryParse(string str, NumberStyle style, out UInt32 result)
		{
			bool sign;
			ulong tmp;
	...
	{
		internal static long Parse(string str)
		{
			long result;
		...
		internal static long Parse(string str, NumberStyle style)
		{
		...
		internal static bool TryParse(string str, out long result)
		{
			result = 0;
			ulong r;
			bool sign;
	...
	internal static class CharExtensions
	{
		...
		/// <param name="p"></param>
		/// <returns></returns>
		internal static string ConvertFromUtf32(int p)
		{
			char c = (char)p;
			return c.ToString();
		}
    ...
    {
        internal const int MaxDoubleDigits = 16;
        ...
        internal static bool TryParseUInt64Core(string str, bool parseHex, out ulong result, out bool sign)
        {
            if (str == null)
            {
